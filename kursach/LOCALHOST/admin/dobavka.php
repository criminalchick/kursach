...
<form method="POST" enctype="multipart/form-data">
    <input type="file" class="but1" name="image" /><br>
    <input type="text" class="text" name="name" placeholder="Enter name" /><br>
    <input type="text" class="text" name="marka" placeholder="Enter marka" /><br>
    <input type="text" class="text" name="opis" placeholder="Enter opis" /><br>
    <input type="submit" class="but2" value="Загрузить товар" />
</form>